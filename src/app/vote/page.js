...
export default function Vote() {
  ...
  const DEFAULT_OPTION = { name: "Loading...", image: "https://i0.statig.com.br/bancodeimagens/ao/z5/hh/aoz5hh00gkrgjje1rq2laod9k.jpg" };
  ...
  function getOption(option) {
    switch(option) {
      case "raul": return { name: "Raul", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZCldKgmO2Hs0UGk6nRClAjATKoF9x2liYYA&usqp=CAU" }
      case "pablo": return { name: "Pablo", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJ3IlOhNUR958RfPptJypd8a01aj2oEGjFWg&usqp=CAU" }
      ...
      <div className="container col-xxl-8 px-4 py-5">
        ...
        <div className="row flex-lg-row-reverse align-items-center g-1 py-5">
          ...
          <div className="col-5">
            ...
            <img src={option2.image} className="d-block mx-auto rounded" width="250" height="250" />
            {
              showVotes > 0 || voting.maxDate < (Date.now() / 1000)
              ? <button className="btn btn-secondary p-3 my-2 d-block mx-auto" style={{ width: 250 }} disabled={true}>
                {showVotes === 2 ? Number(voting.votes2) + 1 : Number(voting.votes2)} votos
              </button>
              : <button className="btn btn-primary p-3 my-2 d-block mx-auto" style={{ width: 250 }} onClick={btnVote2Click}>
                Quero que saia esse
              </button>
            }
          </div>
          <div className="col-5">
            ...
            <img src={option1.image} className="d-block mx-auto rounded" width="250" height="250" />
            {
              showVotes > 0 || voting.maxDate < (Date.now() / 1000)
              ? <button className="btn btn-secondary p-3 my-2 d-block mx-auto" style={{ width: 250 }} disabled={true}>
                {showVotes === 1 ? Number(voting.votes1) + 1 : Number(voting.votes1)} votos
              </button>
              : <button className="btn btn-primary p-3 my-2 d-block mx-auto" style={{ width: 250 }} onClick={btnVote1Click}>
                Quero que saia esse
              </button>
            }
          </div>
